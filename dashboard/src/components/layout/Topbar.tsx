...
export function Topbar() {
	...
	return (
		<header className='flex items-center gap-3 px-4 py-2.5 bg-[#0e1520] border-b border-[#1c2a3a]'>
			...
			<div className='ml-auto flex items-center gap-2'>
				...
				<span className='text-[11px] text-slate-500'>{anyOnline ? 'Device connected' : 'No devices online'}</span>
			</div>
		</header>
	);
}
